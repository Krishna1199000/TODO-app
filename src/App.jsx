import { useState, useEffect } from 'react' // State management hooks
import Navbar from './components/Navbar'
import { FaEdit } from "react-icons/fa"; // icons for edit and delete actions
import { AiFillDelete } from "react-icons/ai";
import { v4 as uuidv4 } from 'uuid'; // generated unique id
...
function App() { 
  ...
  // it takes todos from local storage and parse the json to javascript array
  useEffect(() => {
  ...
  // it take todo and parse java script array intp stringify
